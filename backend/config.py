...
def _resolve_database_url() -> str:
    """Ensure consistent path for SQLite or PostgreSQL, supporting /tmp for serverless read-only filesystems."""
    raw_url = os.getenv("DATABASE_URL", "").strip()

    # If PostgreSQL connection string is provided
    if raw_url:
    ...
    # Fallback to SQLite (local file or serverless /tmp)
